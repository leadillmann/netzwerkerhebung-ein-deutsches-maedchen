...
V(EgoHBS[[1]])[(V(EgoHBS[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS[[1]])[(V(EgoHBS[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS[[1]])[(V(EgoHBS[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS[[1]])[(V(EgoHBS[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??
...
V(EgoHBS2[[1]])[(V(EgoHBS2[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS2[[1]])[(V(EgoHBS2[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS2[[1]])[(V(EgoHBS2[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS2[[1]])[(V(EgoHBS2[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??
...
V(EgoHBS3[[1]])[(V(EgoHBS3[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS3[[1]])[(V(EgoHBS3[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS3[[1]])[(V(EgoHBS3[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS3[[1]])[(V(EgoHBS3[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??
...
V(EgoHBS4[[1]])[(V(EgoHBS4[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS4[[1]])[(V(EgoHBS4[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS4[[1]])[(V(EgoHBS4[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS4[[1]])[(V(EgoHBS4[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??
...
H6 <- delete_edges(edm, E(edm)[age>"3"]) # alle Kanten bzw Knoten loeschen, die nicht aus Heidis Pubert??t stammen
H7 <- delete_edges(H6, E(H6)[age<"3"]) # alle Kanten bzw Knoten loeschen, die nicht aus Heidis Pubert??t stammen
...
V(EgoHBS5[[1]])[(V(EgoHBS5[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS5[[1]])[(V(EgoHBS5[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS5[[1]])[(V(EgoHBS5[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS5[[1]])[(V(EgoHBS5[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??
...
H8 <- delete_edges(edm, E(edm)[age>"4"]) # alle Kanten bzw Knoten loeschen, die nicht aus Heidis Pubert??t stammen
H9 <- delete_edges(H8, E(H8)[age<"4"]) # alle Kanten bzw Knoten loeschen, die nicht aus Heidis Pubert??t stammen
...
V(EgoHBS6[[1]])[(V(EgoHBS6[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS6[[1]])[(V(EgoHBS6[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS6[[1]])[(V(EgoHBS6[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS6[[1]])[(V(EgoHBS6[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??
...
V(EgoHBS7[[1]])[(V(EgoHBS7[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS7[[1]])[(V(EgoHBS7[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS7[[1]])[(V(EgoHBS7[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS7[[1]])[(V(EgoHBS7[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoHBS7[[1]], vertex.label=NA) # Visualisierung ohne Label, order=1
```
```{r Egonetzwerk NSU}
EgoNSU <- make_ego_graph(edm, order=1, c("Nationalsozialistischer Untergrund"))

V(EgoNSU[[1]])[(V(EgoNSU[[1]])$naziweight=="0")]$color <- "#D6D6D6" # kein Nazi, sehr helles grau
V(EgoNSU[[1]])[(V(EgoNSU[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoNSU[[1]])[(V(EgoNSU[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoNSU[[1]])[(V(EgoNSU[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoNSU[[1]])[(V(EgoNSU[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoNSU[[1]])
```
```{r Egonetzwerk von Heidis Vater}
EgoVR<- make_ego_graph(edm, order=1, c("Vater Redeker von Heidi"))

V(EgoVR[[1]])[(V(EgoVR[[1]])$naziweight=="0")]$color <- "#D6D6D6" # kein Nazi, sehr helles grau
V(EgoVR[[1]])[(V(EgoVR[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoVR[[1]])[(V(EgoVR[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoVR[[1]])[(V(EgoVR[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoVR[[1]])[(V(EgoVR[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoVR[[1]])
```
```{r Egonetzwerk von Heidi mit Kultur}
# Kantenfarben zur??cksetzen
E(edm)[(E(edm)$familyweight > "1" )]$color <- "grey"
E(edm)[(E(edm)$familyweight < "5" )]$color <- "grey"

#H12 <- delete_edges(edm, E(edm)[familyrelation<"4"]) # alle Kanten loeschen, die nicht mit Kultur zusammen h??ngen 

#H13 <- delete_edges(H12, E(H12)[familyrelation>"4"]) # alle Kanten loeschen, die nicht mit Kultur

H12 <- delete_vertices(edm, V(edm)[category<"1"]) # alle Knoten loeschen, die nicht zu Schriften z??hlen
H13 <- delete_vertices(H12, V(H12)[category>"3"]) # alle Knoten loeschen, die nicht zu Schriften z??hlen
...
V(EgoHBS8[[1]])[(V(EgoHBS8[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS8[[1]])[(V(EgoHBS8[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS8[[1]])[(V(EgoHBS8[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS8[[1]])[(V(EgoHBS8[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoHBS8[[1]])
```
```{r Egonetzwerk von Heidi aus ihrer fr??hen Kindheit + nur Kanten, die eine enge Beziehung darstellen}
E(edm)[(E(edm)$familyweight > "1" )]$color <- "grey"
E(edm)[(E(edm)$familyweight < "5" )]$color <- "grey"

H14 <- delete_edges(edm, E(edm)[age>"1"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis frueher Kindheit stammen

H15 <- delete_edges(H14, E(H14)[familyweight>"1"]) # alle Kanten loeschen, die nicht der Beziehung "eng" entsprechen
EgoHBS9 <- make_ego_graph(H15, order=3, c("Heidi Benneckenstein"))

V(EgoHBS9[[1]])[(V(EgoHBS9[[1]])$naziweight=="0")]$color <- "#D6D6D6" # kein Nazi, sehr helles grau
V(EgoHBS9[[1]])[(V(EgoHBS9[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS9[[1]])[(V(EgoHBS9[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS9[[1]])[(V(EgoHBS9[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS9[[1]])[(V(EgoHBS9[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoHBS9[[1]])
```
```{r Egonetzwerk von Heidi aus ihrer Kindheit + nur Kanten, die eine enge Beziehung darstellen}
E(edm)[(E(edm)$familyweight > "1" )]$color <- "grey"
E(edm)[(E(edm)$familyweight < "5" )]$color <- "grey"

H16 <- delete_edges(edm, E(edm)[age<"2"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis Kindheit stammen
H17 <- delete_edges(H16, E(H16)[age>"2"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis Kindheit stammen
H18 <- delete_edges(H17, E(H17)[familyweight>"1"]) # alle Kanten loeschen, die nicht der Beziehung "eng" entsprechen
EgoHBS10 <- make_ego_graph(H18, order=3, c("Heidi Benneckenstein"))

V(EgoHBS10[[1]])[(V(EgoHBS10[[1]])$naziweight=="0")]$color <- "#D6D6D6" # kein Nazi, sehr helles grau
V(EgoHBS10[[1]])[(V(EgoHBS10[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS10[[1]])[(V(EgoHBS10[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS10[[1]])[(V(EgoHBS10[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS10[[1]])[(V(EgoHBS10[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoHBS10[[1]])
```
```{r Egonetzwerk von Heidi aus ihrer Pubert??t + nur Kanten, die eine enge Beziehung darstellen}
E(edm)[(E(edm)$familyweight > "1" )]$color <- "grey"
E(edm)[(E(edm)$familyweight < "5" )]$color <- "grey"

H19 <- delete_edges(edm, E(edm)[age<"3"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis Pubertaet stammen
H20 <- delete_edges(H19, E(H19)[age>"3"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis Pubertaet stammen
H21 <- delete_edges(H20, E(H20)[familyweight>"1"]) # alle Kanten loeschen, die nicht der Beziehung "eng" entsprechen
EgoHBS11 <- make_ego_graph(H21, order=3, c("Heidi Benneckenstein"))

V(EgoHBS11[[1]])[(V(EgoHBS11[[1]])$naziweight=="0")]$color <- "#D6D6D6" # kein Nazi, sehr helles grau
V(EgoHBS11[[1]])[(V(EgoHBS11[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS11[[1]])[(V(EgoHBS11[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS11[[1]])[(V(EgoHBS11[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS11[[1]])[(V(EgoHBS11[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoHBS11[[1]])
```
```{r Egonetzwerk von Heidi aus ihrer Jugend + nur Kanten, die eine enge Beziehung darstellen}
E(edm)[(E(edm)$familyweight > "1" )]$color <- "grey"
E(edm)[(E(edm)$familyweight < "5" )]$color <- "grey"

H22 <- delete_edges(edm, E(edm)[age<"4"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis Jugend stammen
H23 <- delete_edges(H22, E(H22)[age>"4"]) # alle Kanten bzw Knoten l??schen, die nicht aus Heidis Jugend stammen
H24 <- delete_edges(H23, E(H23)[familyweight>"1"]) # alle Kanten loeschen, die nicht der Beziehung "eng" entsprechen
EgoHBS12 <- make_ego_graph(H24, order=3, c("Heidi Benneckenstein"))

V(EgoHBS12[[1]])[(V(EgoHBS12[[1]])$naziweight=="0")]$color <- "#D6D6D6" # kein Nazi, sehr helles grau
V(EgoHBS12[[1]])[(V(EgoHBS12[[1]])$naziweight=="1")]$color <- "#A9A9A9" # Mitlaeufer, hellgrau
V(EgoHBS12[[1]])[(V(EgoHBS12[[1]])$naziweight=="2")]$color <- "#5F5E5F" # Nazi, dunkelgrau
V(EgoHBS12[[1]])[(V(EgoHBS12[[1]])$naziweight=="3")]$color <- "#000000" # Nazi-Groe??e, schwarz
V(EgoHBS12[[1]])[(V(EgoHBS12[[1]])$naziweight=="6")]$color <- "#FFFFFF" # nicht zugeordnet, wei??

plot(EgoHBS12[[1]])
```
```{r Egonetzwerk von Heidi als sie Erwachsen ist + nur Kanten, die eine enge Beziehung darstellen}
E(edm)[(E(edm)$familyweight > "1" )]$color <- "grey"
E(edm)[(E(edm)$familyweight < "5" )]$color <- "grey"

H25 <- delete_edges(edm, E(edm)[age<"5"]) # alle Kanten bzw Knoten loeschen, die nicht aus Heidis Jugend stammen
H26 <- delete_edges(H25, E(H25)[familyweight>"1"]) # alle Kanten loeschen, die nicht der Beziehung "eng" entsprechen
EgoHBS13 <- make_ego_graph(H26, order=3, c("Heidi Benneckenstein"))

V(EgoHBS13[[1]])[(V(EgoHBS13[[1]])$naziweight>"0")]$color <- "#FFFFFF" # alle Knoten, wei??
