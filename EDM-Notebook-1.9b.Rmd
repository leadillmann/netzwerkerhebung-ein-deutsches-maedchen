...
H3 <- delete_edges(edm, E(edm)[age>"4"]) # alle Kanten bzw Knoten löschen, die nicht aus Heidis Kindheit stammen
...
```{r Ego-Netzwerk von HBS mit Clustern}

edmCL <- cluster_walktrap(edm)
...
plot(edmCL, edm,
     layout=layout_with_kk, 
     #rescale=FALSE, ylim = c(-2.0,2.0), xlim = c(-2.0,2.0), asp=0,
     ...
     #main="Ein Deutsches Mädchen",
     sub="Heidis Ego-Netzwerk, Unterteilung in Clustern",
     )
